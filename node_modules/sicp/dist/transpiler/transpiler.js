...
exports.transpile = exports.checkForUndefinedVariables = exports.evallerReplacer = exports.getBuiltins = exports.getGloballyDeclaredIdentifiers = exports.hoistImportDeclarations = exports.transformImportDeclarations = void 0;
...
function transpileToFullJS(program) {
    const usedIdentifiers = new Set((0, uniqueIds_1.getIdentifiersInProgram)(program));
    const [modulePrefix, importNodes, otherNodes] = transformImportDeclarations(program, usedIdentifiers);
...
function transpile(program, context, skipUndefined = false) {
    if (context.chapter === types_1.Chapter.FULL_JS || context.variant == types_1.Variant.NATIVE) {
