...
test('no export function', () => {
    ...
    `, { chapter: types_1.Chapter.LIBRARY_PARSER }).toMatchInlineSnapshot(`"Line 1: Export named declarations are not allowed"`);
});
...
test('no export default', () => {
    ...
    const x = 1;
    export default x;
    `, { chapter: types_1.Chapter.LIBRARY_PARSER }).toMatchInlineSnapshot(`"Line 2: Export default declarations are not allowed"`);
});
